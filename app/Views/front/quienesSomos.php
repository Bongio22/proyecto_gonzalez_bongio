...
<div class="containerQuienesSomos my-5">
    ...
    <!-- Fila para los contenedores internos -->
    <div class="row gy-4">
        <!-- Agregado espacio vertical entre columnas -->
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center border rounded shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <p class="card-text">
                        Fundador de FrikiVerse, se encarga del control y actualización de stock, asegurando que la
                        tienda siempre cuente con lo que el cliente busca.
                    </p>
                </div>
            </div>
        </div>
