    ...
    <section class="dashboard">
        ...
        <div class="actions">
            <div class="action-buttons">
                <a href="<?= base_url('productos'); ?>" class="btn">Agregar Producto</a>
                <a href="<?= base_url('listadoUsuarios'); ?>" class="btn">Agregar Usuario</a>
            </div>
            <a href="<?= base_url('principal'); ?>" class="btn-Volver">Volver Inicio</a>
        </div>
    </section>
</div>
...
<style>
    ...
    .stat-item {
        background-color: #fff; /* Fondo blanco para las estadísticas */
        border-radius: 8px;
        padding: 20px;
        box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); /* Sombra para las estadísticas */
        text-align: center;
    ...
    .btn-Volver {
        ...
        text-decoration: none; /* Eliminar subrayado */
        display: inline-block; /* Asegura que el enlace se comporte como un botón */
        margin-top: 10px; /* Espacio superior para separar del grupo de botones */
    }
    ...
    .notifications {
        background-color: #f8d7da; /* Color de fondo para notificaciones */
        padding: 15px;
        border-radius: 5px;
        text-align: center;
    }
